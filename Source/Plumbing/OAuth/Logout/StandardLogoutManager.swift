...
struct StandardLogoutManager: LogoutManager {
    ...
    /*
     * This is a no op since the standard end session endpoint is used
     */
    ...
    /*
     * Treat state mismatch errors as success, since a state may not be returned in the response
     */
